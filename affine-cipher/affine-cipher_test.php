...
class AffineCipherTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals(1, gcd(5, 7));
    }

    public function testGCD2()
    {
        $this->assertEquals(1, gcd(11, 7));
    }

    public function testGCD3()
    {
        $this->assertEquals(2, gcd(18, 26));
    }

    public function testLetterIndexA()
    {
        $this->assertEquals(0, letter2Index('a'));
    }

    public function testLetterIndexB()
    {
        $this->assertEquals(1, letter2Index('b'));
    }

    public function testLetterIndexC()
    {
        $this->assertEquals(2, letter2Index('c'));
    }

    public function testLetterIndexZ()
    {
        $this->assertEquals(25, letter2Index('z'));
    }

    public function testMMI1()
    {
        $this->assertEquals(4, mmi(3, 11));
    }

    public function testMMI2()
    {
        $this->assertEquals(7, mmi(3, 10));
    }

    public function testEncodeExercism()
    {
        $this->assertEquals('tytgn fjr', encode('exercism', 3, 7));
    }
}
