...
class TriangleTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testDegenerate1()
    {
        $this->assertEquals(
            'degenerate',
            (new Triangle(1, 2, 3))->kind()
        );
    }

    public function testDegenerate2()
    {
        $this->assertEquals(
            'degenerate',
            (new Triangle(10, 4, 6))->kind()
        );
    }

    public function testDegenerate3()
    {
        $this->assertEquals(
            'degenerate',
            (new Triangle(6, 20, 14))->kind()
        );
    }
}
